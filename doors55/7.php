...
<title> Модель 7 - межкомнатные двери| ТОО Российские Двери</title>
<meta name="Description" content="межкомнатные двери, купить современные двери в Алматы, двери из России, двери эконом, стильные двери ">
<meta name="Keywords" content="дери, межкомнатные, деревянные двери, магазин дверей, купить, орех, эконом класс">
...
///
function pageload(){
	if(get!="")document.door.src=('_doors_img_/06/'+pic[get]);
...
<td colspan="3" align="left" height="40" width="600" valign="middle">
  ...
  <strong class="doors_name">Модель "7" </strong><span class="doors_description_t">фабрика "Поставский Мебельный центр" Беларусь, г.Поставы</span><br /><br />
        ...
        <div class="doors_img" id="fonback">
          <table class="doors-back" style="background: url(&quot;_doors_img_/nalichnik/transpar_back.png&quot;) repeat scroll 0% 0% transparent;" border="0" cellpadding="0" cellspacing="0" width="500">
            <tbody><tr valign="bottom">
              <td align="right" height="80"><img src="b_dveri_volna_files/empty_left_verh.gif" name="nal_vert_left" id="nal_vert_left" height="15" width="15"></td>
              <td align="center" height="80" width="160"><img src="b_dveri_volna_files/empty_hor.gif" name="nal_hor" id="nal_hor" height="15" width="160"></td>
              <td align="left" height="80"><img src="b_dveri_volna_files/empty_right_verh.gif" name="nal_vert_right" id="nal_vert_right" height="15" width="15"></td>
            </tr>
            <tr>
              <td align="right" height="420" valign="bottom"><table border="0" cellpadding="0" cellspacing="0" width="15">
                  <tbody><tr>
                    <td height="420"><img src="b_dveri_volna_files/empty_vert.gif" name="nal_vert_1" id="nal_vert_1" border="0" height="420" width="15"></td>
                  </tr>
                  
                </tbody></table></td>
              <td height="420"><img src="b_dveri_7_files/7.jpg" name="door" id="door" border="0" height="420" width="160"></td>
             
              <td align="left" height="420" valign="bottom"><table border="0" cellpadding="0" cellspacing="0" width="15">
                  <tbody><tr>
                    <td height="420"><img src="b_dveri_volna_files/empty_vert.gif" name="nal_vert_2" id="nal_vert_2" border="0" height="420" width="15"></td>
                  </tr>
...
<strong class="doors_description_t">Описание</strong><br />
         Модель "7" рамочно-щитовой конструкции. <br />
Каркас и все детали выполнены из массива сосны. При этом на поверхности дверного полотна отсутствуют сучки и различные другие дефектные места. <br />
В варианте М7-ГШ поверхность покрыта шпоном сосны. <br />
Толщина полотна 40 мм. <br />

Габариты дверного полотна :	2000х600, 700, 800, 900мм.<br />

Отделка :	Поверхность модели М7-ГШ покрыта шпоном сосны (толщина шпона 4мм).
