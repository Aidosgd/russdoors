...
<title> Двери Волна | ТОО Российские Двери</title>
<meta name="Description" content="межкомнатные двери Волна, купить современные двери в Алматы, двери из России, двери эконом, стильные двери ">
...
<td colspan="3" align="left" height="40" width="600" valign="middle">
  ...
  <strong class="doors_name">Модель "Волна" </strong><span class="doors_description_t">завод "Дверлайн" г.Челябинск</span><br /><br />
        ...
        <div class="doors_img" id="fonback">
          <table class="doors-back" style="background: url(&quot;_doors_img_/nalichnik/transpar_back.png&quot;) repeat scroll 0% 0% transparent;" border="0" cellpadding="0" cellspacing="0" width="500">
            ...
            <tr>
              ...
              <td height="420"><img src="b_dveri_volna_files/volna.jpg" name="door" id="door" border="0" height="420" width="160"></td>
