...
<title> Модель 20 - межкомнатные двери| ТОО Российские Двери</title>
...
<td colspan="3" align="left" height="40" width="600" valign="middle">
  ...
  <strong class="doors_name">Модель "20" </strong><span class="doors_description_t">фабрика "Поставский Мебельный центр" Беларусь, г.Поставы</span><br /><br />
        ...
        <div class="doors_img" id="fonback">
          <table class="doors-back" style="background: url(&quot;_doors_img_/nalichnik/transpar_back.png&quot;) repeat scroll 0% 0% transparent;" border="0" cellpadding="0" cellspacing="0" width="500">
            ...
            <tr>
              ...
              <td height="420"><img src="b_dveri_20_files/20.jpg" name="door" id="door" border="0" height="420" width="160"></td>
...
• Варианты полотна - частичное остекление <br />

• Полотно покрыто искусственным шпоном<br />
• Пленка (MASA DEKOR Германия)<br />
• Багет - МДФ ламинированный<br />
• Стекло белое матовое(снег) художественное<br />
• Упаковка: картон , полиэтилен<br />
• Размеры: 600/700/800/900х2000мм<br />
• Толщина полотна: 36 мм<br />
