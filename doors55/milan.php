...
<title>Милан - двери межкомнатные | ТОО Российские Двери</title>
<meta name="Description" content="межкомнатные двери Милан в цвете падук, купить современные двери в Алматы, двери из России, двери классические, стильные двери ">
<meta name="Keywords" content="дери, межкомнатные, деревянные двери, магазин дверей, купить, падук">
...
<script type="text/javascript">
 ...
 p_door = '_doors_img_/milan/';
 
    pic = new Array()
 pic[0] = "milan_glass.jpg";
 pic[1] = "milan.jpg";
...
///
function paduk_ugol(){
	document.nal_vert_1.src = p_nal+'paduk_vert.jpg';
	document.nal_vert_2.src = p_nal+'paduk_vert.jpg';
	document.nal_vert_left.src = p_nal+'paduk_vert_left_ugol.jpg';
	document.nal_vert_right.src = p_nal+'paduk_vert_right_ugol.jpg';
	document.nal_hor.src = p_nal+'paduk_hor.jpg';};
...
<td colspan="3" align="left" height="40" width="600" valign="middle">
  ...
  <strong class="doors_name">Модель "Милан" </strong><span class="doors_description_t">компания "Belwooddoors" Беларусь, г.Минск</span><br /><br />
        ...
        <div class="doors_img" id="fonback">
          <table class="doors-back" style="background: url(&quot;_doors_img_/nalichnik/transpar_back.png&quot;) repeat scroll 0% 0% transparent;" border="0" cellpadding="0" cellspacing="0" width="500">
            ...
            <tr>
              ...
              <td height="420"><img src="b_dveri_milan_files/milan_glass.jpg" name="door" id="door" border="0" height="420" width="160"></td>
...
<strong class="doors_description_t">Описание</strong><br />
         •  Модель "Милан" выполнена в двух вариантах: полотно глухое и остекленное полотно<br />

• Покрытие - шпон fine-line в цвете падук  <br />

• В остекленных моделях используется стекло "белый Мателюкс" с художественным рисунком
<br />
<br />
