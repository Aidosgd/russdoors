...
<title>Глэйс - современные двери | ТОО Российские Двери</title>
<meta name="Description" content="межкомнатные современные двери Глэйс, купить двери в Алматы, двери из России, двери модерн ">
...
//
//
  pic[0] = "gleis_milan_oreh.jpg";
  pic[1] = "gleis_orehglass.jpg";
 pic[10] = "gleis_milan.jpg";
 pic[11] = "gleis_oreh.jpg";
...
function work(){		 
    ...
    if (radio[i].checked) 
		{num_color=i
		 ...
		 if(i==0){
			polotno='milan';
		    if(nalich=='oreh'){milan(); nalich='milan';}
			if(nalich=='oreh_ugol'){milan_ugol(); nalich='milan_ugol';}
		  };
		  // венге
		 if(i==1){
			polotno='oreh';
		 	if(nalich=='milan'){oreh(); nalich='oreh';}
			if(nalich=='milan_ugol'){oreh_ugol(); nalich='oreh_ugol';}
			};
		 }};
	//
	num = num_polotno+num_color;
	//
	document.door.src = '_doors_img_/gleis/'+pic[num];
}	
///////////////////////////////////////////////////////////////////////////////////////////////
function nalichnik(){
	// наличники
	...
	for(var i = 0; i< radio2.length; i++){
	  if(radio2[i].checked){
		...
		if(i==1){//угловое соединение
		   if(polotno=='milan'){milan_ugol(); nalich='milan_ugol';}		  	
		  if(polotno=='oreh'){oreh_ugol(); nalich='oreh_ugol';}
		  }
	  };
	};
...
///
function milan_ugol(){
	      document.getElementById('nal_vert1').src = '_doors_img_/nalichnik/milan_vert.jpg';
		  document.getElementById('nal_vert2').src = '_doors_img_/nalichnik/milan_vert.jpg';
		  document.getElementById('nal_vert_left').src = '_doors_img_/nalichnik/milan_vert_left_ugol.jpg';
		  document.getElementById('nal_vert_right').src = '_doors_img_/nalichnik/milan_vert_right_ugol.jpg';
		  document.getElementById('nal_hor').src = '_doors_img_/nalichnik/milan_hor.jpg' };

///
function oreh_ugol(){
		  document.getElementById('nal_vert1').src = '_doors_img_/nalichnik/g_oreh_vert.jpg';
		  document.getElementById('nal_vert2').src = '_doors_img_/nalichnik/g_oreh_vert.jpg';
		  document.getElementById('nal_vert_left').src = '_doors_img_/nalichnik/g_oreh_vert_left_ugol.jpg';
		  document.getElementById('nal_vert_right').src = '_doors_img_/nalichnik/g_oreh_vert_right_ugol.jpg';
		  document.getElementById('nal_hor').src = '_doors_img_/nalichnik/g_oreh_hor.jpg'};
///
function tablecolor(obj){
		  document.getElementById('fonback').style.background = obj.style.background;} 
///
function pageload(){
	if(get!="")document.door.src='_doors_img_/gleis/'+pic[get];
	switch (get){
	case '0': 
	...
	case '11': 
		...
		document.getElementsByName("color")[1].checked="checked"; 
		polotno='oreh'; break;
	default: document.door.src='_doors_img_/gleis/'+pic[0];};}
</script>
...
<td colspan="3" align="left" height="40" width="600" valign="middle">
  ...
  <strong class="doors_name">Модель "Глэйс" </strong><span class="doors_description_t">торговый дом "Бекар" г. Москва</span><br /><br />
    ...
    <td colspan="3" valign="bottom" align="left"><div class="doors_back">
        <div class="doors_img" id="fonback">
          <table class="doors-back" style="background: url(&quot;_doors_img_/nalichnik/transpar_back.png&quot;) repeat scroll 0% 0% transparent;" width="500" border="0" cellpadding="0" cellspacing="0">
            <tbody><tr valign="bottom">
              <td align="right" height="80"><img src="b_dveri_gleis_files/empty_left_verh.gif" name="nal_vert_left" id="nal_vert_left" width="15" height="15"></td>
              <td width="160" align="center" height="80"><img src="b_dveri_gleis_files/empty_hor.gif" name="nal_hor" id="nal_hor" width="160" height="15"></td>
              <td align="left" height="80"><img src="b_dveri_gleis_files/empty_right_verh.gif" name="nal_vert_right" id="nal_vert_right" width="15" height="15"></td>
            </tr>
            <tr>
              <td valign="bottom" align="right" height="420"><img src="b_dveri_gleis_files/empty_vert.gif" name="nal_vert1" id="nal_vert1" width="15" height="420"></td>
              <td width="160" height="420"><img src="b_dveri_gleis_files/gleis_milan_oreh.jpg" name="door" id="door" width="160" height="420"></td>
              <td valign="bottom" align="left" height="420"><img src="b_dveri_gleis_files/empty_vert.gif" name="nal_vert2" id="nal_vert2" width="15" height="420"></td>
            </tr>
          </tbody></table>
        </div>
        <div class="doors_property">
          ...
          <dl>
            ...
            <dt style="margin-left: 48px;">
              <label>
                <input name="color" id="radio7" value="milan" checked="checked" onclick="work()" type="radio">
                Миланский орех</label>
            </dt>
            <dt style="margin-left: 48px;">
              <label>
                <input name="color" id="radio8" value="oreh" onclick="work()" type="radio">
                Орех</label>
            </dt>
          </dl>
          <dl>
...
<strong class="doors_description_t">Описание</strong><br />
          • Цвет: миланский орех, орех<br />

• Гладкое полотно покрыто искуственным шпоном, 
пленка (MASA DEKOR Германия), багет - МДФ ламинированный<br />

• Упаковка - полиэтилен, пенопласт<br />

• Размер полотен: 600, 700, 800, 900х2000 мм<br />
