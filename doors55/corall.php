...
<title>Коралл - классические двери | ТОО Российские Двери</title>
<meta name="Description" content="межкомнатные класические двери Коралл, купить классические двери в Алматы, двери из России, двери классика">
...
polotno = 'dub';
 ...
 p_door = '_doors_img_/corall/';
 
//////////////////////////////////////////
  pic[0] = "coral_dub_glass.jpg";
  pic[1] = "coral_itoreh_glass.jpg";
  pic[2] = "coral_oreh_glass.jpg";
  pic[3] = "coral_vishnya_glass.jpg";
 pic[10] = "coral_dub.jpg";
 pic[11] = "coral_itoreh.jpg";
 pic[12] = "coral_oreh.jpg";
 pic[13] = "coral_vishnya.jpg";
		...
		{num_color=i; 
		 ...
		 if(i==1){ // итальянский орех
		  ...
		  if(i==2){// орех
			polotno='ioreh';
		    if(nalich=='void')voids();
			if(nalich=='nalich')oreh();
					  
		    };
		  if(i==3){// вишня
			polotno='ivori';
		    if(nalich=='void')voids();
			if(nalich=='nalich')vishnya();
	...
	for(var i = 0; i< radio2.length; i++){
	  if(radio2[i].checked){
		...
		if(i==1){//наличник
		  ...
		  if(polotno=='oreh')oreh();
		  if(polotno=='vishnya')vishnya();
		  }
...
///
function dub(){
	document.nal_vert_1.src = p_nal+'dub_vert.jpg';
	document.nal_vert_2.src = p_nal+'dub_vert.jpg';
	document.nal_vert_left.src = p_nal+'dub_vert_left_ugol.jpg';
	document.nal_vert_right.src = p_nal+'dub_vert_right_ugol.jpg';
	document.nal_hor.src = p_nal+'dub_hor.jpg';};
///
...
function vishnya(){
	document.nal_vert_1.src = p_nal+'vishnya_vert.jpg';
	document.nal_vert_2.src = p_nal+'vishnya_vert.jpg';
	document.nal_vert_left.src = p_nal+'vishnya_vert_left_ugol.jpg';
	document.nal_vert_right.src = p_nal+'vishnya_vert_right_ugol.jpg';
	document.nal_hor.src = p_nal+'vishnya_hor.jpg';};
///
...
////
function pageload(){
	if(get!="")document.door.src='_doors_img_/corall/'+pic[get];
	switch (get){
	case '0': 
	...
	default: 
		document.door.src='_doors_img_/corall/'+pic[0]};}
</script>
 <!-- main -->
...
<td colspan="3" align="left" height="40" width="600" valign="middle">
  ...
  <strong class="doors_name">Модель "Коралл" </strong><span class="doors_description_t">торговый дом "Бекар" г. Москва</span><br /><br />
    ...
    <td colspan="3" align="left" valign="bottom"><div class="doors_back">
        <div class="doors_img" id="fonback">
          <table class="doors-back" style="background: url(&quot;_doors_img_/nalichnik/transpar_back.png&quot;) repeat scroll 0% 0% transparent;" border="0" cellpadding="0" cellspacing="0" width="500">
            ...
            <tr>
              ...
              <td height="420" width="160"><img src="b_dveri_corall_files/coral_dub_glass.jpg" name="door" id="door" height="420" width="160"></td>
        ...
        <div class="doors_property">
          ...
          <dl>
            ...
            <dt style="margin-left: 48px;">
              <label>
                <input name="color" id="radio7" value="dub" checked="checked" onclick="work()" type="radio">
                Дуб </label>
            </dt>
            <dt style="margin-left: 48px; ">
              <label>
            ...
            <dt style="margin-left: 48px; ">
              <label>
                <input name="color" id="radio8" value="vishnya" onclick="work()" type="radio">
                Вишня</label>
            </dt>
...
<strong class="doors_description_t">Описание</strong><br />
          • Цвет: дуб ,орех, вишня, итальянский орех<br />

• Варианты полотна: глухое / частичное остекление <br />

• Полотно с фрезерованной филенкой по сосне с искусственным шпоном, который покрыт синтетическим лаком<br />

• Штапик – сосна тонированная <br />
• Cтекло рифленое<br />
