...
<title>Гранд - двери межкомнатные | ТОО Российские Двери</title>
<meta name="Description" content="межкомнатные двери Гранд в цвете венге, купить современные двери в Алматы, двери из России, двери классические, стильные двери ">
<meta name="Keywords" content="дери, межкомнатные, деревянные двери, магазин дверей, купить, венге">
...
<script type="text/javascript">
 ...
 p_door = '_doors_img_/grand/';
 
    pic = new Array()
 pic[0] = "grand_glass.jpg";
 pic[1] = "grand.jpg";
        ...
        <div class="doors_img" id="fonback">
          <table class="doors-back" style="background: url(&quot;_doors_img_/nalichnik/transpar_back.png&quot;) repeat scroll 0% 0% transparent;" border="0" cellpadding="0" cellspacing="0" width="500">
            ...
            <tr>
              ...
              <td height="420"><img src="b_dveri_grand_files/grand_glass.jpg" name="door" id="door" border="0" height="420" width="160"></td>
...
<strong class="doors_description_t">Описание</strong><br />
          Модель "Гранд" изготовлена из клееного щита из массива сосны, облицованного шпоном с применением стабилизирующей МДФ-подложки для предотвращения деформации полотна в процессе эксплуатации.<br />

Изготовление филенок осуществляется путем облицовывания заготовки из МДФ шпоном fine-line в цвете венге.
