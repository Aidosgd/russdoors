...
<title>Кантри светлый дуб - классические двери | ТОО Российские Двери</title>
<meta name="Description" content="межкомнатные класические двери Кантри, купить классические двери в Алматы, двери из Белорусии, двери дуб ">
...
<script type="text/javascript">
 ...
 p_door = '_doors_img_/kantri/';
 
    pic = new Array()
 pic[0] = "kantri_glass.jpg";
 pic[1] = "kantri.jpg";
...
///
function pageload(){
	if(get!="")document.door.src=('_doors_img_/kantri/'+pic[get]);
...
<td colspan="3" align="left" height="40" width="600" valign="middle">
  ...
  <strong class="doors_name">Модель "Кантри" </strong><span class="doors_description_t">производитель компания "Халес" Беларусь, г. Смаргонь</span><br /><br />
    ...
    <td colspan="3" align="left" valign="bottom"><div class="doors_back">
        <div class="doors_img" id="fonback">
          <table class="doors-back" style="background: url(&quot;_doors_img_/nalichnik/transpar_back.png&quot;) repeat scroll 0% 0% transparent;" border="0" cellpadding="0" cellspacing="0" width="500">
            <tbody><tr valign="bottom">
              <td align="right" height="80"><img src="b_dveri_kantri_files/empty_left_verh.gif" name="nal_vert_left" id="nal_vert_left" height="15" width="15"></td>
              <td align="center" height="80" width="160"><img src="b_dveri_kantri_files/empty_hor.gif" name="nal_hor" id="nal_hor" height="15" width="160"></td>
              <td align="left" height="80"><img src="b_dveri_kantri_files/empty_right_verh.gif" name="nal_vert_right" id="nal_vert_right" height="15" width="15"></td>
            </tr>
            <tr>
              <td align="right" height="420" valign="bottom"><table border="0" cellpadding="0" cellspacing="0" width="15">
                  <tbody><tr>
                    <td height="380"><img src="b_dveri_kantri_files/empty_380_vert.gif" name="nal_vert_380_1" id="nal_vert_380_1" border="0" height="380" width="15"></td>
                  </tr>
                  <tr>
                    <td height="40"><img src="b_dveri_kantri_files/empty_40_vert.gif" name="nal_vert_40_1" id="nal_vert_40_1" border="0" height="40" width="15"></td>
                  </tr>
                </tbody></table></td>
              <td height="420"><img src="b_dveri_kantri_files/kantri_glass.jpg" name="door" id="door" border="0" height="420" width="160"></td>
              ...
              <td align="left" height="420" valign="bottom"><table border="0" cellpadding="0" cellspacing="0" width="15">
                  <tbody><tr>
                    <td height="380"><img src="b_dveri_kantri_files/empty_380_vert.gif" name="nal_vert_380_2" id="nal_vert_380_2" border="0" height="380" width="15"></td>
                  </tr>
                  <tr>
                    <td height="40"><img src="b_dveri_kantri_files/empty_40_vert.gif" name="nal_vert_40_2" id="nal_vert_40_2" border="0" height="40" width="15"></td>
                  </tr>
                </tbody></table></td>
            </tr>
          </tbody></table>
        ...
        <div class="doors_property">
          ...
          <dl>
            ...
            <dt style="margin-left: 48px;">
              <label>
                <input name="nal" id="nal3" onclick="nalichnik()" value="checkbox" type="radio">
                Наличник + декор гладкий</label>
            </dt>
            <dt style="margin-left: 48px;">
              <label>
                <input name="nal" value="checkbox" id="nal4" onclick="nalichnik()" type="radio">
