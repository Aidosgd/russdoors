...
<title>Ланда - двери межкомнатные | ТОО Российские Двери</title>
<meta name="Description" content="межкомнатные двери Ланда, купить современные двери в Алматы, двери из России, двери классические, стильные двери ">
...
<script type="text/javascript">
 ...
 p_door = '_doors_img_/landa/';
 
    pic = new Array()
 pic[0] = "landa_glass.jpg";
 pic[1] = "landa.jpg";
...
<td colspan="3" align="left" height="40" width="600" valign="middle">
  ...
  <strong class="doors_name">Модель "Ланда" </strong><span class="doors_description_t">компания "Belwooddoors" Беларусь, г.Минск</span><br /><br />
        ...
        <div class="doors_img" id="fonback">
          <table class="doors-back" style="background: url(&quot;_doors_img_/nalichnik/transpar_back.png&quot;) repeat scroll 0% 0% transparent;" border="0" cellpadding="0" cellspacing="0" width="500">
            ...
            <tr>
              ...
              <td height="420"><img src="b_dveri_landa_files/landa_glass.jpg" name="door" id="door" border="0" height="420" width="160"></td>
...
<strong class="doors_description_t">Описание</strong><br />
          Модель межкомнатных дверей "Ланда" изготовлена из клееного щита из массива сосны, облицованного шпоном с применением стабилизирующей МДФ-подложки для предотвращения деформации полотна в процессе эксплуатации.<br />
<br />
