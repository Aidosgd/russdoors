...
<title>Токио 5 - венге | двери модерн | ТОО Российские Двери Алматы</title>
<meta name="Description" content="межкомнатные совеременные двери Токио 5 в японском стиле, купить классические двери в Алматы, двери из Белорусии, двери венге, японский минимализм ">
<meta name="Keywords" content="дери, межкомнатные, деревянные двери, магазин дверей, купить, двери венге, двери в стиле японского минимализма, стильные двери в Алматы ">
...
<script type="text/javascript">
 ...
 p_door = '_doors_img_/tokyo/';
 
    pic = new Array()
 pic[0] = "tokyo_glass.jpg";
 pic[1] = "tokyo.jpg";
...
<td colspan="3" align="left" height="40" width="600" valign="middle">
  ...
  <strong class="doors_name">Модель "Токио 5" </strong><span class="doors_description_t">компания "Халес" Беларусь, г. Смаргонь</span><br /><br />
        ...
        <div class="doors_img" id="fonback">
          <table class="doors-back" style="background: url(&quot;_doors_img_/nalichnik/transpar_back.png&quot;) repeat scroll 0% 0% transparent;" border="0" cellpadding="0" cellspacing="0" width="500">
            <tbody><tr valign="bottom">
              <td align="right" height="80"><img src="b_dveri_tokyo_files/empty_left_verh.gif" name="nal_vert_left" id="nal_vert_left" height="15" width="15"></td>
              <td align="center" height="80" width="160"><img src="b_dveri_tokyo_files/empty_hor.gif" name="nal_hor" id="nal_hor" height="15" width="160"></td>
              <td align="left" height="80"><img src="b_dveri_tokyo_files/empty_right_verh.gif" name="nal_vert_right" id="nal_vert_right" height="15" width="15"></td>
            </tr>
            <tr>
              <td align="right" height="420" valign="bottom"><table border="0" cellpadding="0" cellspacing="0" width="15">
                  <tbody><tr>
                    <td height="420"><img src="b_dveri_tokyo_files/empty_vert.gif" name="nal_vert_1" id="nal_vert_1" border="0" height="420" width="15"></td>
                  </tr>
                  
                </tbody></table></td>
              <td height="420"><img src="b_dveri_tokyo_files/tokyo_glass.jpg" name="door" id="door" border="0" height="420" width="160"></td>
              ...
              <td align="left" height="420" valign="bottom"><table border="0" cellpadding="0" cellspacing="0" width="15">
                  <tbody><tr>
                    <td height="420"><img src="b_dveri_tokyo_files/empty_vert.gif" name="nal_vert_2" id="nal_vert_2" border="0" height="420" width="15"></td>
                  </tr>
...
• Размеры: 2000 x (600, 700, 800, 900) мм<br />
