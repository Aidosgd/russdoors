...
<title>Пальмира - двери классика | ТОО Российские Двери</title>
<meta name="Description" content="межкомнатные двери Пальмира, купить современные двери в Алматы, двери из России, двери классические, стильные двери ">
...
<script type="text/javascript">
 ...
 p_door = '_doors_img_/palmira/';
 
    pic = new Array()
 pic[0] = "palmira_glass.jpg";
 pic[1] = "palmira.jpg";
...
///
function palmira_ugol(){
	document.nal_vert_1.src = p_nal+'palmira_vert.jpg';
	document.nal_vert_2.src = p_nal+'palmira_vert.jpg';
	document.nal_vert_left.src = p_nal+'palmira_vert_left_ugol.jpg';
	document.nal_vert_right.src = p_nal+'palmira_vert_right_ugol.jpg';
	document.nal_hor.src = p_nal+'palmira_hor.jpg';};
...
///
function pageload(){
	if(get!="")document.door.src=('_doors_img_/palmira/'+pic[get]);
...
<td colspan="3" align="left" height="40" width="600" valign="middle">
  ...
  <strong class="doors_name">Модель "Пальмира" </strong><span class="doors_description_t">торговый дом "Бекар" Москва</span><br /><br />
        ...
        <div class="doors_img" id="fonback">
          <table class="doors-back" style="background: url(&quot;_doors_img_/nalichnik/transpar_back.png&quot;) repeat scroll 0% 0% transparent;" border="0" cellpadding="0" cellspacing="0" width="500">
            ...
            <tr>
              ...
              <td height="420"><img src="b_dveri_palmira_files/palmira_glass.jpg" name="door" id="door" border="0" height="420" width="160"></td>
...
• Фанерованное полотно с четвертью, с объемной филенкой<br />
• Штапик - береза или береза тонированная<br />
• Упаковка: картон , полиэтилен<br />
• Отделка полиуретановым лаком Herberts, коробка, петли<br />
• Размеры: 600/700/800/900х2000мм<br />
• Толщина: 40 мм
<br />
