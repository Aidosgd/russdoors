...
<title>Каролина - двери классика | ТОО Российские Двери</title>
<meta name="Description" content="межкомнатные двери Каролина, купить современные двери в Алматы, двери из России, двери классические, стильные двери ">
...
<script type="text/javascript">
 ...
 p_door = '_doors_img_/carolina/';
 
    pic = new Array()
 pic[0] = "carolina_glass.jpg";
 pic[1] = "carolina.jpg";
...
///
function pageload(){
	if(get!="")document.door.src=('_doors_img_/carolina/'+pic[get]);
...
<td colspan="3" align="left" height="40" width="600" valign="middle">
  ...
  <strong class="doors_name">Модель "Каролина" </strong><span class="doors_description_t">компания "Belwooddoors" Беларусь, г.Минск</span><br /><br />
        ...
        <div class="doors_img" id="fonback">
          <table class="doors-back" style="background: url(&quot;_doors_img_/nalichnik/transpar_back.png&quot;) repeat scroll 0% 0% transparent;" border="0" cellpadding="0" cellspacing="0" width="500">
            ...
            <tr>
              ...
              <td height="420"><img src="b_dveri_carolina_files/carolina_glass.jpg" name="door" id="door" border="0" height="420" width="160"></td>
...
<strong class="doors_description_t">Описание</strong><br />
          • Облицовка - шпон дуба, шпон fine-line в цвете орех <br />

• Варианты полотна - глухое / остекленное <br />
(с раскладкой или без)<br />

• Сосновые закладные и раскладка<br />
• Стекло - "Сельвит" бронза<br />
<br />
