...
<title>Лилия - двери межкомнатные | ТОО Российские Двери</title>
<meta name="Description" content="межкомнатные двери Лилия в цвете орех-дуб, купить современные двери в Алматы, двери из России, двери классические, стильные двери ">
<meta name="Keywords" content="дери, межкомнатные, деревянные двери, магазин дверей, купить, дуб, орех">
...
<script type="text/javascript">
 ...
 p_door = '_doors_img_/lilia/';
 
    pic = new Array()
 pic[0] = "lilia_glass.jpg";
 pic[1] = "lilia.jpg";
...
///
function lilia_ugol(){
	document.nal_vert_1.src = p_nal+'lilia_vert.jpg';
	document.nal_vert_2.src = p_nal+'lilia_vert.jpg';
	document.nal_vert_left.src = p_nal+'lilia_vert_left_ugol.jpg';
	document.nal_vert_right.src = p_nal+'lilia_vert_right_ugol.jpg';
	document.nal_hor.src = p_nal+'lilia_hor.jpg';};
...
///
function pageload(){
	if(get!="")document.door.src=('_doors_img_/landa/'+pic[get]);
...
<td colspan="3" align="left" height="40" width="600" valign="middle">
  ...
  <strong class="doors_name">Модель "Гранд" </strong><span class="doors_description_t">компания "Belwooddoors" Беларусь, г.Минск</span><br /><br />
        ...
        <div class="doors_img" id="fonback">
          <table class="doors-back" style="background: url(&quot;_doors_img_/nalichnik/transpar_back.png&quot;) repeat scroll 0% 0% transparent;" border="0" cellpadding="0" cellspacing="0" width="500">
            <tbody><tr valign="bottom">
              <td align="right" height="80"><img src="b_dveri_palmira_files/empty_left_verh.gif" name="nal_vert_left" id="nal_vert_left" height="15" width="15"></td>
              <td align="center" height="80" width="160"><img src="b_dveri_palmira_files/empty_hor.gif" name="nal_hor" id="nal_hor" height="15" width="160"></td>
              <td align="left" height="80"><img src="b_dveri_palmira_files/empty_right_verh.gif" name="nal_vert_right" id="nal_vert_right" height="15" width="15"></td>
            </tr>
            <tr>
              <td align="right" height="420" valign="bottom"><table border="0" cellpadding="0" cellspacing="0" width="15">
                  <tbody><tr>
                    <td height="420"><img src="b_dveri_palmira_files/empty_vert.gif" name="nal_vert_1" id="nal_vert_1" border="0" height="420" width="15"></td>
                  </tr>
                  
                </tbody></table></td>
              <td height="420"><img src="b_dveri_lilia_files/lilia_glass.jpg" name="door" id="door" border="0" height="420" width="160"></td>
             
              <td align="left" height="420" valign="bottom"><table border="0" cellpadding="0" cellspacing="0" width="15">
                  <tbody><tr>
                    <td height="420"><img src="b_dveri_palmira_files/empty_vert.gif" name="nal_vert_2" id="nal_vert_2" border="0" height="420" width="15"></td>
                  </tr>
...
<strong class="doors_description_t">Описание</strong><br />
        Модель "Лилия"  выполнена в двух вариантах (полотно глухое и остекленное).<br />

В качестве облицовки используется  шпон fine-line дуб-радиал совместно со  шпоном fine-line в цвете орех.<br />

В модели применяются  закладные из МДФ.<br />

Финиш-покрытие: трехслойная отделка лаком торговой марки "Becker Acroma" (Швеция) и промежуточной шлифовкой.
