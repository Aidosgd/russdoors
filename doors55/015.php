...
<title> Ìîäåëü 015 | ÒÎÎ Ðîññèéñêèå Äâåðè</title>
<meta name="Description" content="ìåæêîìíàòíûå äâåðè öâåòà ìèëàíñêèé îðåõ, êóïèòü ñîâðåìåííûå äâåðè â Àëìàòû, äâåðè èç Ðîññèè, äâåðè ýêîíîì, ñòèëüíûå äâåðè ">
<meta name="Keywords" content="äåðè, ìåæêîìíàòíûå, äåðåâÿííûå äâåðè, ìàãàçèí äâåðåé, êóïèòü, ìèëàíñêèé îðåõ, ýêîíîì êëàññ">
...
function nalichnik(){
	...
	for(var i = 0; i< radio2.length; i++){
	  if(radio2[i].checked){
		if(i==0){//áåç íàëè÷íèêà
		  voids();};
		
		if(i==1){//óãëîâîå ñîåäèíåíèå
		  milan_ugol();}
...
///
function pageload(){
	if(get!="")document.door.src=('_doors_img_/milan/'+pic[get]);
...
<td colspan="3" align="left" height="40" width="600" valign="middle">
  ...
  <strong class="doors_name">Ìîäåëü "015" </strong><span class="doors_description_t">çàâîä "Äâåðëàéí" ã.×åëÿáèíñê</span><br /><br />
  ...
  <table width="500" border="0" class="catalog_table_x">
    ...
    <td colspan="3" align="left" valign="bottom"><div class="doors_back">
        <div class="doors_img" id="fonback">
          <table class="doors-back" style="background: url(&quot;_doors_img_/nalichnik/transpar_back.png&quot;) repeat scroll 0% 0% transparent;" border="0" cellpadding="0" cellspacing="0" width="500">
            <tbody><tr valign="bottom">
              <td align="right" height="80"><img src="b_dveri_04_files/empty_left_verh.gif" name="nal_vert_left" id="nal_vert_left" height="15" width="15"></td>
              <td align="center" height="80" width="160"><img src="b_dveri_04_files/empty_hor.gif" name="nal_hor" id="nal_hor" height="15" width="160"></td>
              <td align="left" height="80"><img src="b_dveri_04_files/empty_right_verh.gif" name="nal_vert_right" id="nal_vert_right" height="15" width="15"></td>
            </tr>
            <tr>
              <td align="right" height="420" valign="bottom"><table border="0" cellpadding="0" cellspacing="0" width="15">
                  <tbody><tr>
                    <td height="420"><img src="b_dveri_04_files/empty_vert.gif" name="nal_vert_1" id="nal_vert_1" border="0" height="420" width="15"></td>
                  </tr>
                  
                </tbody></table></td>
              <td height="420"><img src="b_dveri_015_files/015.jpg" name="door" id="door" border="0" height="420" width="160"></td>
             
              <td align="left" height="420" valign="bottom"><table border="0" cellpadding="0" cellspacing="0" width="15">
                  <tbody><tr>
                    <td height="420"><img src="b_dveri_04_files/empty_vert.gif" name="nal_vert_2" id="nal_vert_2" border="0" height="420" width="15"></td>
                  </tr>
        ...
        <div class="doors_property">
          <dl>
            <dd style="margin-left: 48px;">Âàðèàíòû ïîëîòíà</dd>
            <dt style="margin-left: 48px;">
              <label>
                <input name="polotno" id="radio3" value="3glass" checked="checked" onclick="work()" type="radio">
                ×àñòè÷íîå îñòåêëåíèå</label>
            </dt>
          </dl>
          <dl>
            <dd style="margin-left: 48px;">Äîïîëíåíèÿ</dd>
            <dt style="margin-left: 48px;">
              <label>
            ...
            <dt style="margin-left: 48px;">
              <label>
                ...
                Íàëè÷íèê (ñîåäèíåíèå ïîä óãëîì)</label>
            </dt>
            
          </dl>
          <dl>
            <dd style="margin-left: 48px; padding-bottom: 5px;">Öâåò ôîíà ñòåíû</dd>
...
<strong class="doors_description_t">Îïèñàíèå</strong><br />
          • Öâåò - ìèëàíñêèé îðåõ <br />

• Âàðèàíòû ïîëîòíà - ÷àñòè÷íîå îñòåêëåíèå <br />

• Ôïîëîòíî ñ èñêóññòâåíûì øïîíîì, êîòîðûé ïîêðûò ñèíòåòè÷åñêèì ëàêîì<br />
 • Øòàïèê – ÌÄÔ ëàìèíèðîâàííûé<br />
• Ñòåêëî ðèôëåíîå<br />
• Óïàêîâêà: êàðòîí , ïîëèýòèëåí<br />
• Ðàçìåðû: 600/700/800/900õ2000ìì<br />
• Òîëùèíà: 35 ìì
<br />
